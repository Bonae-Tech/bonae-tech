...
export const en: Translations = {
  ...
  keyFigures: {
    years: '30+',
    yearsLabel: 'Years of combined experience',
    clients: 'Clients',
  ...
  portfolio: {
    ...
    title: 'Portfolio',
    subtitle: 'Projects that reflect our commitment to excellence.',
    industries: {
      title: 'Industries served',
      items: ['Hospitality and tourism', 'Commerce and retail', 'Restaurants and food service', 'Professional services', 'Entrepreneurships and startups', 'Others'],
    },
    comingSoon: 'Featured projects coming soon. Contact us to learn about success cases.',
  },

  testimonials: {
    sectionBadge: 'What they say',
    title: 'Testimonials',
    subtitle: 'Stories from clients who have trusted us.',
    comingSoon: 'Testimonials coming soon. Be the first to share your experience with Bonae Tech.',
  },
  ...
  plans: {
    ...
    packages: [
      {
        name: 'Basic',
        description: 'Essential digital presence: simple website and social media setup.',
      },
      {
        name: 'Professional',
        description: 'Complete website + social media + basic CRM.',
      },
      {
        name: 'Enterprise',
        description: 'Comprehensive customized solution.',
      },
    ],
    cta: 'Request quote',
  ...
  contact: {
    ...
    locationNote: 'We serve clients remotely throughout Venezuela, Latin America, and the world.',
  },
